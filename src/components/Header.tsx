...
function Logo() {
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className="hidden h-10 w-px bg-white/15 sm:block md:h-12"
      />
      <span className="hidden text-sm font-medium uppercase tracking-[0.25em] text-steel-300 sm:inline md:text-base">
